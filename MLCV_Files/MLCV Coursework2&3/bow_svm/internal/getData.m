...
switch MODE
    ...
    case 'Caltech' % Caltech dataset
        ...
        %save('kmeans75','idx','C','sumd','D');
        %load kmeans75.mat
        
        %SIFT visulisation
        figure;
        vl_plotsiftdescriptor(desc_tr{c,i}(:,10));
        ...
        % write your own codes here
        %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        %Represent image in bow (higher level abstraction) 
        ...
        for imagec=1:10
            for imagei=1:15
                  ...
                  %Find the SIFT decriptors for the specified image class
                  %and index
                  ...
                  if imagei<2 && (imagec==3 || imagec==4 )
                      ...
                      imgList = dir(fullfile(subFolderName,'*.jpg'));
                      I = imread(fullfile(subFolderName,imgList(imgIdx_tr(imagei)).name));
                      imshow(I);
        ...
        for imagec=1:10
            for imagei=1:15
                  ...
                  if imagei<2 && (imagec==3 || imagec==4 )
                      ...
                      subFolderName = fullfile(folderName,classList{imagec});
                      imgList = dir(fullfile(subFolderName,'*.jpg'));
                      I = imread(fullfile(subFolderName,imgList(imgIdx_te(imagei)).name));
                      imshow(I);
